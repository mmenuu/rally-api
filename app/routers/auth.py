...
from ..databases import persons_collection, User
...
def authenticate_user(username: str, password: str):
    user = persons_collection.get_person_by_username(username)
    if not user:
        return False
...
async def register(body: dict):
    ...
    if persons_collection.get_person_by_username(body["username"]):
        raise HTTPException(
    ...
    persons_collection.add_person(new_user)
